...
Disable mDNS on all clients that don´t need it.  
...
new-ItemProperty -Path "HKLM:\Software\Policies\Microsoft\Windows NT\DNSClient" -name "EnableMulticast" -Value 0 -Type DWord
```
...
```
[http://woshub.com/how-to-disable-netbios-over-tcpip-and-llmnr-using-gpo/](http://woshub.com/how-to-disable-netbios-over-tcpip-and-llmnr-using-gpo/)   

Disable mDNS:  
```
Set-ItemProperty "HKLM:\SYSTEM\CurrentControlSet\Services\Dnscache\Parameters\" -Name EnableMDNS -Value 0
New-ItemProperty "HKLM:\SYSTEM\CurrentControlSet\Services\Dnscache\Parameters\" -Name EnableMDNS -Value 0 -Type DWord
```
[https://www.fortalicesolutions.com/posts/common-attack-paths-and-how-to-prevent-them](https://www.fortalicesolutions.com/posts/common-attack-paths-and-how-to-prevent-them)  
