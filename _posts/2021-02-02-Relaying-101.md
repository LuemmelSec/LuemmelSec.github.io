...
A rewrite rule to route all traffic for 10.55.0.100:445 to ourselfs 10.55.0.30:445
...
The ```internal``` switch will tell bettercap to do ARP poisoning on it´s own subnet, otherwise the attack won´t work.  
